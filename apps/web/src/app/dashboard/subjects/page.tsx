...
type Subject = { subjectId: string; subjectName: string; description: string | null };
...
export default function SubjectsPage() {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    if (!name.trim()) return;
    try {
      await subjectsApi.create({ subjectName: name.trim(), description: description.trim() || undefined });
      setName('');
      setDescription('');
      setShowAdd(false);
      load();
